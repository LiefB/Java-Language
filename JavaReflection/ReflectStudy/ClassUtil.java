...
public class ClassUtil {
    ...
    public static void printClassMethodMessage(Object obj){
        ...
        for (int i = 0; i < ms.length; i++) {
            ...
            int pnum = paramTypes.length;
            if (pnum >= 1) {
                for (int p = 0; p < pnum - 1; p++) {
                    System.out.print(paramTypes[p].getName() + ", ");
                }
                System.out.print(paramTypes[paramTypes.length - 1].getName());
            }
            System.out.println(")");
        }
    }
    ...
    public static void printClassConstructorMessage(Object obj) {
         ...
         * getDeclaredConstructors获取的是该类所有的构造函数的信息
         */
