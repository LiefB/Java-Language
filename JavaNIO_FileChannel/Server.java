        ...
        while (true) {
            ...
            while (it.hasNext()) {
                ...
                if (key.isAcceptable()) {
                    ...
                    File file = new File("E:\\" + remoteAddress.getHostName() + "_" + remoteAddress.getPort()
                            + "_" + new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()) + ".txt");
